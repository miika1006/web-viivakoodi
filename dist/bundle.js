...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_main_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(17);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n\tdisplay: flex;\n\tgap: 1em;\n\tfont-family: monospace;\n\tflex: 50%;\n}\nvideo {\n\twidth: 300px;\n\theight: 100%;\n\tbackground-color: rgb(41, 41, 41);\n}\n@media (max-width: 800px) {\n\tbody {\n\t\tflex-direction: column;\n\t}\n\tvideo {\n\t\twidth: 100%;\n\t}\n}\n", "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AAAA;CACC,aAAa;CACb,QAAQ;CACR,sBAAsB;CACtB,SAAS;AACV;AACA;CACC,YAAY;CACZ,YAAY;CACZ,iCAAiC;AAClC;AACA;CACC;EACC,sBAAsB;CACvB;CACA;EACC,WAAW;CACZ;AACD","sourcesContent":["body {\n\tdisplay: flex;\n\tgap: 1em;\n\tfont-family: monospace;\n\tflex: 50%;\n}\nvideo {\n\twidth: 300px;\n\theight: 100%;\n\tbackground-color: rgb(41, 41, 41);\n}\n@media (max-width: 800px) {\n\tbody {\n\t\tflex-direction: column;\n\t}\n\tvideo {\n\t\twidth: 100%;\n\t}\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _styles_main_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(10);
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (!("BarcodeDetector" in window)) {
              log("Barcode Detector is not supported by this browser, cannot read barcodes with camera.");
            } else {
              log("Barcode Detector supported!");

              if (!(navigator.mediaDevices && navigator.mediaDevices.getUserMedia)) {
                log("Media devices is not supported by this browser, cannot start videostream.");
              } else {
...
var startVideoStreaming = /*#__PURE__*/function () {
  var _ref2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2(video) {
    var videoSettings;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return navigator.mediaDevices.getUserMedia(videoSettings);
  ...
  return function startVideoStreaming(_x) {
    return _ref2.apply(this, arguments);
  };
}();

var detectOnRender = function detectOnRender(video) {
  ...
  return window.requestAnimationFrame(function () {
    return detectOnRender(video);
  });
};

var detectBarcode = /*#__PURE__*/function () {
  var _ref3 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee3(video) {
    var barcodeDetector, barcodes, distinctBarcodes, x;
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            barcodeDetector = new BarcodeDetector({
              formats: ["code_128", "code_93", "data_matrix", "ean_8", "itf", "pdf417", "code_39", "codabar", "ean_13", "qr_code", "upc_e"]
            });
            _context3.next = 4;
            return barcodeDetector.detect(video);

          case 4:
            barcodes = _context3.sent;

            if (barcodes.length > 0) {
              distinctBarcodes = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(new Map(barcodes.map(function (item) {
                return [item["rawValue"], item];
              })).values());

              for (x = 0; x < distinctBarcodes.length; x++) {
          ...
          case 8:
            ...
            log("Failed to detect barcode: code=" + _context3.t0.code + ", message=" + _context3.t0.message + ", name=" + _context3.t0.name);
  ...
  return function detectBarcode(_x2) {
    return _ref3.apply(this, arguments);
  };
}();

var log = function log(data, obj) {
  console.log(data, obj ? obj : "");
  var newLogRow = document.createElement("div");
  ...
  var logHolder = document.getElementById("logholder");
